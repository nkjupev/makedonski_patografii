  ...
  const dict = {
    ...
    about: {
      mk: {
        ...
        aboutIntroP1:
          "Истражувањето „Гласови на телото: Архиви на сведоштва (патографија и фикција)“ е дел од проектот „Траумата во литературата“, реализиран од Институтот за македонска литература, со поддршка на Министерството за образование и наука. Раководителка на проектот беше проф. д-р Ана Мартиноска. Дел од резултатите од ова истражување ќе бидат претставени во научен труд, во зборникот трудови на овој проект. Овој материјал претставува негова дигитална истражувачка надградба, оформена како отворена онлајн архива наменета за натамошно истражување и размена на знаење.",
        aboutIntroP2:
    ...
    author: {
      mk: {
        ...
        authorP1:
          "Д-р Тамара Ќупева е виша научна соработничка во Институт за македонска литература, Универзитет „Св. Кирил и Методиј“ во Скопје. Нејзиниот научноистражувачки и професионален ангажман се движи на пресекот меѓу книжевноста, образованието и современите медиуми, со особен интерес за дигитална хуманистика, медицинска хуманистика, вештачка интелигенција и трансформацијата на знаењето во дигиталната ера.",
        authorP2:
