  ...
  const dict = {
    ...
    author: {
      mk: {
        ...
        authorP1:
          "Д-р Тамара Ќупева е виша научна соработничка во Институт за македонска литература, при Универзитетот „Св. Кирил и Методиј“ во Скопје. Нејзиниот научноистражувачки и професионален ангажман се движи на пресекот меѓу книжевноста, образованието и современите медиуми, со особен интерес за дигитална хуманистика, медицинска хуманистика, вештачка интелигенција и трансформацијата на знаењето во дигиталната ера.",
        authorP2:
