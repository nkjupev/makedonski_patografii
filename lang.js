  ...
  const dict = {
    ...
    about: {
      mk: {
        ...
        aboutIntroP1:
          "Истражувањето „Гласови на телото — Архиви на сведоштва“ (патографија и фикција) е дел од проектот „Траумата во литературата“, реализиран од Институтот за македонска литература, со поддршка на Министерството за образование и наука. Раководител на проектот беше проф. д-р Ана Мартиноска. Дел од резултатите од ова истражување се објавени во научен труд, во зборникот трудови на овој проект. Овој материјал претставува негова дигитална истражувачка надградба, оформена како отворена онлајн архива наменета за натамошно истражување и размена на знаење.",
        aboutIntroP2:
        ...
        aboutIntroP3:
          "Овие текстови се јавни сведоштва на лична, преживеана траума и претставуваат еден вид репозиториум на лични сеќавања. Авторите на овие сведоштва пишуваат со сопствена, интуитивна и емотивна логика на изразување, во форма на романи, раскази, документарна проза, мемоари, писма и дневници и во различни жанровски формации (патографија, автопатографија или хетеропатографија), хибридна автофикција, патографска фикција и полифонични (колективни) сведоштва, а нивните приказни се огледало на интимните доживувања од соочувањето и прифаќањето на новата стварност, но и на општеството, обременето со предрасуди, незнаење, стигма и недоволно разбирање.",
        aboutIntroP5:
          "Од овие причини, процесот на книжевно архивирање на овие текстови се фокусираше на пошироката книжевна, документарна, етичка и хуманистичка вредност, што ја надминува естетската проценка. Нараторите на овие приказни се гласови што треба да бидат слушнати.",
        aboutCuratorHeading: "За авторката на архивата",
        aboutCuratorP1:
          "Д-р Тамара Ќупева е виш научен соработник во Институт за македонска литература, при Универзитетот „Св. Кирил и Методиј“ во Скопје. Нејзиниот научноистражувачки и професионален ангажман се движи на пресекот меѓу книжевноста, образованието и современите медиуми, со особен интерес за дигитална хуманистика, медицинска хуманистика, вештачка интелигенција и трансформацијата на знаењето во дигиталната ера.",
        aboutCuratorP2:
    ...
    author: {
      mk: {
        ...
        authorP1:
          "Д-р Тамара Ќупева е виша научна соработничка во Институт за македонска литература, при Универзитетот „Св. Кирил и Методиј“ во Скопје. Работи како истражувач во Одделението за библиографија, документација, библиотека и информатика. Нејзиниот научноистражувачки и професионален ангажман се движи на пресекот меѓу книжевноста, образованието и современите медиуми, со особен интерес за дигитална хуманистика, медицинска хуманистика, вештачка интелигенција и трансформацијата на знаењето во дигиталната ера.",
        authorP2:
          "Авторка е на бројни научни трудови, книги, монографии и библиографии, посветени на литературата, педагогијата, комуникацијата и медиумската писменост, а активно учествува и во национални и меѓународни истражувачки проекти, конференции и научни симпозиуми. Како предавач и обучувач, има долгогодишно искуство во развој и имплементација на едукативни програми, особено во областа на медиумската писменост. Нејзиниот професионален профил вклучува и ангажман во креирање образовни политики и реформи, како и активно учество во академски и институционални тела.",
        footerCopy: "© 2025 · Прва архива · Медицинска хуманистика · Северна Македонија"
      },
      en: {
        navHome: "Home",
